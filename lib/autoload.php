    ...
    function($class) {
        ...
        if ($classes === null) {
            $classes = array(
                ...
                'mineichen\\entitymanager\\repository\\repositoryrecord' => '/Repositories/RepositoryRecord.php',
                'mineichen\\entitymanager\\repository\\repositoryrecordgenerator' => '/Repositories/RepositoryRecordGenerator.php',
